...
/**
  ...
  @param {string} [pubkey_prefix = 'DAO']
*/
function PublicKey(Q, pubkey_prefix = 'DAO') {
    if(typeof Q === 'string') {
     ...
     * @arg {string} [pubkey_prefix = 'DAO'] - public key prefix
    */
    function toString(pubkey_prefix = 'DAO') {
...
/**
  ...
  @param {string} [pubkey_prefix = 'DAO']
*/
PublicKey.isValid = function(pubkey, pubkey_prefix = 'DAO') {
    try {
...
*/
PublicKey.fromString = function(public_key, pubkey_prefix = 'DAO') {
    try {
...
/**
    ...
    @return PublicKey
*/
PublicKey.fromStringOrThrow = function(public_key, pubkey_prefix = 'DAO') {
